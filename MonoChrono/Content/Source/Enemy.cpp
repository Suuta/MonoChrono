...
void Enemy::Draw()
{
    ...
    FOR(50)
    {
        ...
        conioex2::Draw((int)Location.X + i + 5, (int)Location.Y - 9, " ", 3 << 4, 0);
        conioex2::Draw((int)Location.X + i + 5, (int)Location.Y - 8, " ", 3 << 4, 0);
    }
    FOR(HP / 2)
    {
        conioex2::Draw((int)Location.X + i + 5, (int)Location.Y - 10, " ", 13 << 4, 0);
        conioex2::Draw((int)Location.X + i + 5, (int)Location.Y - 9, " ", 13 << 4, 0);
        conioex2::Draw((int)Location.X + i + 5, (int)Location.Y - 8, " ", 13 << 4, 0);
    }
}
